...
CREATE TABLE `article` (
                           ...
                           `circle_id` BIGINT COMMENT '圈子 ID',
                           `tag_ids` JSON COMMENT '标签 ID 列表', -- 存储为 JSON 数组
...
CREATE TABLE `article_like` (
                                ...
                                `article_id` BIGINT NOT NULL COMMENT '点赞文章 ID',
...
CREATE TABLE `comment_like` (
                                ...
                                `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '点赞时间',
                                `user_id` BIGINT NOT NULL COMMENT '点赞用户 ID',
                                `comment_id` BIGINT NOT NULL COMMENT '点赞评论 ID',
...
CREATE TABLE `follow` (
                          `id` BIGINT PRIMARY KEY AUTO_INCREMENT,
                          `create_time` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
                          `follower_user_id` BIGINT NOT NULL COMMENT '关注者 ID',
                          `following_user_id` BIGINT NOT NULL COMMENT '被关注者 ID',
